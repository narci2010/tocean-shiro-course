...
import com.toceansoft.shiro.demo15.Constants;
import com.toceansoft.shiro.demo15.service.ClientService;
import com.toceansoft.shiro.demo15.service.OAuthService;
	...
	public Object authorize(Model model, HttpServletRequest request)
		...
		try {
			...
			final OAuthResponse response = OAuthASResponse
					.errorResponse(HttpServletResponse.SC_FOUND).error(e).location(redirectUri)
					.buildQueryMessage();
			HttpHeaders headers = new HttpHeaders();
			headers.setLocation(new URI(response.getLocationUri()));
			return new ResponseEntity(headers, HttpStatus.valueOf(response.getResponseStatus()));
