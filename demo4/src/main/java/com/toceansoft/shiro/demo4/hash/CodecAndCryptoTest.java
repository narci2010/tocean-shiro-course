package com.toceansoft.shiro.demo4.hash;
...
public class CodecAndCryptoTest {
	...
	public void testBlowfishCipherService() {
		...
		// 加密
		String encrptText = blowfishCipherService.encrypt(text.getBytes(), key.getEncoded())
				.toHex();
		// 解密
		String text2 = new String(
	...
	public void testDefaultBlockCipherService() throws Exception {
		...
		// 解密
		String text2 = new String(
				cipherService.decrypt(Hex.decode(encrptText), key.getEncoded()).getBytes());
