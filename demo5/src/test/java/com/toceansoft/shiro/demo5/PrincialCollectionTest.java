...
public class PrincialCollectionTest extends BaseTest {
	...
	public void test() {
		...
		login("classpath:shiro-multirealm.ini", "toceansoft", "123");
		...
		// 因为MyRealm1和MyRealm2返回的凭据都是toceansoft，所以排重了
		List<Object> principals = princialCollection.asList(); // asList和asSet的结果一样
