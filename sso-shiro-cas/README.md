...
## 系统模块说明
1.  cas：  单点登录模块，这里直接拿的是cas的项目改了点样式而已 把cas目录拷贝到tomcat的webapps目录即可 。
2.  doc：   文档目录，里面有数据库生成语句，采用的是MySQL5.0，数据库名为sso_db  
3.  spring-node-1：   应用1 mvn tomcat7:run
4.  spring-node-2：   应用2 mvn tomcat7:run
...
<!-- 设置密码的加密方式，这里使用的是MD5加密 -->
  ...
  <!-- 设置数据源 -->
	 <bean id="dataSource" class="org.springframework.jdbc.datasource.DriverManagerDataSource">
		  ...
		  <property name="url" value="jdbc:mysql://127.0.0.1:3306/sso_db?useUnicode=true&amp;characterEncoding=utf8"></property>
