...
public class OrganizationDaoImpl implements OrganizationDao {
	...
	public Organization updateOrganization(Organization organization) {
		...
		jdbcTemplate.update(sql, organization.getName(), organization.getParentId(),
				organization.getParentIds(), organization.getAvailable(), organization.getId());
		return organization;
	}
	...
	public void move(Organization source, Organization target) {
		...
		jdbcTemplate.update(moveSourceDescendantsSql, target.makeSelfAsParentIds(),
				source.makeSelfAsParentIds(), source.makeSelfAsParentIds() + "%");
	}
}
