...
<%@taglib prefix="toceanfn" uri="http://www.toceansoft.com/tags/toceansoft-functions" %>
<html>
<head>
    <title></title>
...
<body>
    ...
    <form:form method="post" commandName="role">
        ...
        <div class="form-group">
            ...
            <input type="text" id="resourceName" name="resourceName" value="${toceanfn:resourceNames(role.resourceIds)}" readonly>
    ...
    <script>
        $(function () {
            ...
            var zNodes =[
                ...
                { id:${r.id}, pId:${r.parentId}, name:"${r.name}", checked:${toceanfn:in(role.resourceIds, r.id)}},
                </c:if>
                </c:forEach>
            ];
