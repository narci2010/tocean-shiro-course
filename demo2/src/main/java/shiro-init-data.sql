...
insert into users(username, password, password_salt) values('toceansoft', '123', null);
insert into user_roles(username, role_name) values('toceansoft', 'role1');
insert into user_roles(username, role_name) values('toceansoft', 'role2');
